...
public class GradosConf extends WsConfigurerAdapter {
    ...
    @Bean(name = "grados")
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema gradosSchema) {
        DefaultWsdl11Definition wsdl = new DefaultWsdl11Definition();
        wsdl.setPortTypeName("gradosPort");
        wsdl.setLocationUri("/ws");
        wsdl.setTargetNamespace("https://t4is.uv.mx/grados");
        wsdl.setSchema(gradosSchema);
        return wsdl;
    }
